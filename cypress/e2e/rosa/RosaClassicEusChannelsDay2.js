...
const clusterProperties = clusterDetails['rosa-classic-public']['day1-profile'];
const clusterName = clusterProperties.ClusterName;
const day2Profile = clusterDetails['rosa-classic-public']['day2-profile'];

describe(
  'ROSA Classic Cluster - [Day 2] Channel Group Dropdown Validations (OCP-85454)',
  { tags: ['day2', 'rosa', 'classic', 'channel-group', 'dropdown-validation'] },
  () => {
    before(() => {
     ...
     */
    it('Step ROSA Classic - Day 2 - Verify edit icon behavior based on cluster state', () => {
    ...
    it('Step ROSA Classic - Day 2 - Channel Group Dropdown - Verify modal and dropdown options', () => {
      // Click on the channel group selector to open the modal
    ...
    it('Step ROSA Classic - Day 2 - Channel Group Dropdown - Verify all available options', () => {
    ...
    it('Step ROSA Classic - Day 2 - Channel Group Dropdown - Test Cancel functionality', () => {
    ...
    it('Step ROSA Classic - Day 2 - Channel Group Dropdown - Test changing channel group', () => {
    ...
    it('Step ROSA Classic - Day 2 - Channel Group Dropdown - Verify each channel option is selectable', () => {
    ...
    it('Step ROSA Classic - Day 2 - Click on Version Update button from Overview tab and verify upgrade wizard modal', () => {
    ...
    it('Step ROSA Classic - Day 2 - Upgrade Wizard - Select version and proceed', () => {
    ...
    it('Step ROSA Classic - Day 2 - Verify upgrade details are displayed correctly on the Overview tab', () => {
    ...
    it('Step ROSA Classic - Day 2 - View scheduled update details and cancel the update', () => {
     ...
     */
    it('Step ROSA Classic - Day 2 - Verify channel group definitions match fixture data', () => {
     ...
     */
    it('Step ROSA Classic - Day 2 - Verify upgrade schedule strategy', () => {
      ...
      ClusterDetailsPage.channelGroupModalSelect().select('candidate');
