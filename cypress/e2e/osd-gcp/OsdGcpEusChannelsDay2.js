...
const clusterProperties = clusterProfiles['osd-ccs-gcp-public-singlezone-serviceaccount']['day1-profile'];

describe(
  'OSD GCP CCS Cluster - [Day 2] Channel Group Dropdown Validations (OCP-85454)',
  { tags: ['day2', 'osd', 'gcp', 'channel-group', 'dropdown-validation'] },
  () => {
    beforeEach(() => {
    ...
    it('Step OSD GCP - Day 2 - Channel Group Dropdown - Verify modal and dropdown options', () => {
    ...
    it('Step OSD GCP - Day 2 - Channel Group Dropdown - Verify all available options', () => {
    ...
    it('Step OSD GCP - Day 2 - Channel Group Dropdown - Test Cancel functionality', () => {
    ...
    it('Step OSD GCP - Day 2 - Channel Group Dropdown - Test changing channel group', () => {
    ...
    it('Step OSD GCP - Day 2 - Channel Group Dropdown - Verify each channel option is selectable', () => {
    ...
    it('Step OSD GCP - Day 2 - Click on Version Update button from Overview tab and verify upgrade wizard modal', () => {
    ...
    it('Step OSD GCP - Day 2 - Upgrade Wizard - Select version and proceed', () => {
  ...
  // Verify Next button is enabled
    ...
    it('Step OSD GCP - Day 2 - Verify upgrade details are displayed correctly on the Overview tab', () => {
    ...
    it('Step OSD GCP - Day 2 - Verify update status and cancel update option are shown', () => {
    ...
    it('Step OSD GCP - Day 2 - Cancel the scheduled update', () => {
