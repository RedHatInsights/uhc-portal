...
**Description:**
To support React hooks and more modern aspects of React, most of the old-style class-based components will be converted to more modern functional components. This change will reduce the amount of code needed to connect with other parts of React, including Redux, React Query, Formik, etc.

**Acceptance Criteria:**
Except for `src/chrome-main.tsx` and `src/testUtils.test.tsx`, no class-based components will be in the code base.

**Out of Scope:**
- Any other code refactoring including: converting to TypeScript, refactoring unit tests into RTL, and moving from Redux to React Query
- Any user-facing functionality changes/additions

**Testing Implications:**
Because there won't be any user-facing changes, the use of existing tests (unit, e2e, manual) can be used to test this area. No new tests are expected to be needed.
