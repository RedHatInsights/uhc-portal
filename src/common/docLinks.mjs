...
const docLinks = {
  ...
  ROSA_HCP_EXT_AUTH: `${ROSA_DOCS_BASE}/install_clusters/rosa-hcp-sts-creating-a-cluster-ext-auth`,
  ROSA_HCP_BREAK_GLASS: `${ROSA_DOCS_BASE}/install_clusters/rosa-hcp-sts-creating-a-cluster-ext-auth#rosa-hcp-sts-accessing-a-break-glass-cred-cli_rosa-hcp-sts-creating-a-cluster-ext-auth`,
