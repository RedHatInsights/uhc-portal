  ...
  return isOpen ? (
    <Formik
      ...
      onSubmit={async (values) => {
        // OCMUI-4183: Only include proxy object if any proxy field changed
        // to avoid sending empty proxy object that corrupts existing config
        const httpProxy = OnlyReturnValueIfChanged(
