...
describe('<ClustersPageHeader />', () => {
  ...
  describe('Refresh Functionality', () => {
    it('calls refetch for clusters when refresh button is clicked', async () => {
    ...
    it('calls refetch for cluster transfers when refresh button is clicked', async () => {
      const { user } = withState({}, true).render(<ClustersPageHeader />);
  ...
  describe('Accessibility', () => {
    ...
    it('has proper aria-label for loading spinner', () => {
      ...
      const spinner = screen.getByRole('progressbar', { name: 'Loading cluster list data' });
      expect(spinner).toHaveAttribute('aria-label', 'Loading cluster list data');
    });
  });
});
