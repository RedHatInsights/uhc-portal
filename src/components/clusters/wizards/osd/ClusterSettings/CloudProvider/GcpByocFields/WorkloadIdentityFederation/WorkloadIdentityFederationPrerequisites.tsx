...
import { useIsOSDFromGoogleCloud } from '../../../../useIsOSDFromGoogleCloud';
          ...
          {!isOSDFromGoogleCloud && (
            <li>
              <Content component={ContentVariants.p} className="ocm-secondary-text">
                ...
                to make sure your Google Cloud account has the necessary resource quotas and limits
                to support the size cluster you want.
              </Content>
            </li>
          )}
          <li>
