...
export const test = base.extend<{}, WorkerFixtures>({
  ...
  // Worker-scoped: GlobalNavPage instance - created once, reused across all tests in suite
  globalNavPage: [
    async ({ authenticatedPage }, use) => {
      const pageObject = new GlobalNavPage(authenticatedPage);
      await use(pageObject);
    },
    { scope: 'worker' },
  ],
