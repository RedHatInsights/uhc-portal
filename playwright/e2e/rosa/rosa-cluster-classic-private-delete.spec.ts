...
const clusterDetails = require('../../fixtures/rosa/rosa-cluster-classic-private-creation-advanced.spec.json');
const clusterNamePrefix = clusterDetails['rosa-classic-private-advanced'].ClusterNamePrefix;

test.describe.serial(
  'ROSA classic cluster - Delete private advanced cluster',
  { tag: ['@day2', '@rosa', '@rosa-classic', '@delete', '@private', '@multizone'] },
  () => {
