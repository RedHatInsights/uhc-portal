...
// Note: currentOcVersion functionality would need to be implemented in Playwright if needed
...
test.describe.serial('OCM Overview Page tests (OCP-65189)', { tag: ['@smoke'] }, () => {
  ...
  test('OCM Overview Page - Featured products section', async () => {
  ...
  test('OCM Overview Page - Recommended Operators section', async () => {
    // Check header link
