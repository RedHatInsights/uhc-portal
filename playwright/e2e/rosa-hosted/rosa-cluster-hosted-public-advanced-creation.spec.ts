...
test.describe.serial(
  ...
  () => {
    ...
    test.beforeAll(async ({ customCommands, navigateTo }) => {
    ...
    test(`Step - Cluster Settings - CIDR Ranges - CIDR default valuesfor ${clusterName}`, async ({
      createRosaWizardPage,
    }) => {
    ...
    test('Step - Cluster update - update statergies and its definitions', async ({
      createRosaWizardPage,
    }) => {
