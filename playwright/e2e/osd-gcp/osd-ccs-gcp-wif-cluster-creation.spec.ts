...
const gcpClusterProperties = require('../../fixtures/osd-gcp/osd-ccs-gcp-wif-cluster-creation.spec.json');
...
test.describe.serial(
  'OSD GCP CCS WIF cluster creation tests (OCP-35992, OCP-26750)',
  { tag: ['@smoke', '@osd'] },
  () => {
