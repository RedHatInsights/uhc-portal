...
const gcpClusterProperties = require('../../fixtures/osd-gcp/osd-ccs-gcp-sa-cluster-creation.spec.json');
...
test.describe.serial(
  'OSD GCP CCS Service Account cluster creation tests (OCP-35992, OCP-26750)',
  { tag: ['@smoke', '@osd'] },
  () => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType} wizard - Billing model and its definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Cluster Settings - Cloud provider definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Cluster Settings - Cluster details definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Cluster Settings - Default machinepool definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Networking configuration - cluster privacy definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - CIDR configuration - cidr definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Cluster updates definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
      ...
      await createOSDWizardPage.selectGracePeriod(gcpClusterProperties.NodeDraining);
      await page.locator(createOSDWizardPage.primaryButton).click();
    });

    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Review and create page and its definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD ${gcpClusterProperties.CloudProvider} ${authType}  wizard - Cluster submission & overview definitions`, async ({
      createOSDWizardPage,
      clusterDetailsPage,
    }) => {
    ...
    test(`Delete OSD ${gcpClusterProperties.CloudProvider} ${authType}  cluster`, async ({
      page,
      clusterDetailsPage,
    }) => {
