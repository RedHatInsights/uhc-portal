...
test.describe.serial('Check all cluster lists page items presence and its actions (OCP-21339)', { tag: ['@play'] }, () => {
  ...
  test('Cluster list page : filters & its actions', async () => {
    ...
    const emptyStateHeading = sharedPage.locator('h4').filter({ hasText: "Let's create your first cluster" });
