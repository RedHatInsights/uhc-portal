...
const { Clusters } = require('../../fixtures/osd/OsdTrialClusterProperties.json');
...
test.describe('OSD Trial cluster creation tests (OCP-39415)', { tag: ['@smoke'] }, () => {
  Clusters.forEach((clusterProperties: any) => {
    test.describe(`${clusterProperties.CloudProvider}`, () => {
