...
const { Clusters } = require('../../fixtures/osd/OsdMarketplaceClusterProperties.json');
...
test.describe('OSD Marketplace cluster creation tests (OCP-67514)', { tag: ['@smoke'] }, () => {
  Clusters.forEach((clusterProperties: any) => {
    ...
    test.describe(`${clusterProperties.CloudProvider} ${authType} ${isPscEnabled}-${clusterProperties.Marketplace}`, () => {
